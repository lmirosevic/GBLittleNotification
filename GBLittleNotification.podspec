Pod::Spec.new do |s|
  ...
  s.source_files  = 'GBLittleNotification/GBLittleNotification.{h,m}', 'GBLittleNotification/GBLittleNotificationStencil.{h,m}', 'GBLittleNotification/GBLittleNotificationStencil+Presets.{h,m}', 'GBLittleNotification/GBLittleNotificationManager.{h,m}', 'GBLittleNotification/GBLittleNotificationTypes.h'
